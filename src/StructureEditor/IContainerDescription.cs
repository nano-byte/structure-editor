...
public interface IContainerDescription<TContainer> where TContainer : class
{
    ...
    /// <summary>
    /// Adds a polymorphic list to the description, i.e. a list whose elements can be one of several types.
    /// </summary>
    ...
    IListDescription<TContainer, TList> AddPolymorphicList<TList>(Func<TContainer, IList<TList>> getList)
        where TList : class;
