...
public class PropertyElementNode<TContainer, TProperty, TElement, TEditor>(string name, TContainer container, PropertyPointer<TProperty?> pointer, TElement element, bool nullable = true)
